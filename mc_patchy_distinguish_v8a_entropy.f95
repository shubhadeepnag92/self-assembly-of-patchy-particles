...
!
	...
	real*8,allocatable    :: uh(:,:,:),ah(:,:,:),ap(:,:),a_p(:,:),ac(:,:),a_c(:,:),x(:),patch_rsqrt(:,:),entropy(:)
...
!	CALCULATE THE FINAL ENERGY
	...
	write(32,*) imc,E_final, Elj_final, Elj_final + E_final*(natom*eps_patch*2), nbonds, order_parameter, entropy(imc), total_entropy &
        ,(Elj_final+E_final*(natom*eps_patch*2))-T*entropy(imc)
